...
export const apiService = {
  ...
  async getAeratorTemplates() {
    try {
      const response = await fetch(`${API_URL}/api/aerator-templates`);
  ...
  async submitSurvey(data) {
    try {
      ...
      // Use the API endpoint from Vercel config
      const apiUrl = `${API_URL}/compare`;
...
function getMockResults(data) {
  ...
  const winner = (aerator1.sotr / aerator1.cost) > (aerator2.sotr / aerator2.cost) ? aerator1 : aerator2;
  ...
  const mockEquilibriumPrice = Math.round((winner.sotr / loser.sotr) * loser.cost * 0.9);
    ...
    "aeratorResults": [
      {
        ...
        "total_power_hp": Math.ceil(data.farm.tod / aerator1.sotr) * aerator1.power_hp,
        "total_initial_cost": Math.ceil(data.farm.tod / aerator1.sotr) * aerator1.cost,
        "annual_energy_cost": 25000,
        "annual_maintenance_cost": Math.ceil(data.farm.tod / aerator1.sotr) * aerator1.maintenance,
        "annual_replacement_cost": (Math.ceil(data.farm.tod / aerator1.sotr) * aerator1.cost) / aerator1.durability,
        "total_annual_cost": 50000,
        "cost_percent_revenue": 10,
        "aerators_per_ha": Math.ceil(data.farm.tod / aerator1.sotr) / data.farm.farm_area_ha,
        "hp_per_ha": (Math.ceil(data.farm.tod / aerator1.sotr) * aerator1.power_hp) / data.farm.farm_area_ha,
      ...
      },
      {
        ...
        "total_power_hp": Math.ceil(data.farm.tod / aerator2.sotr) * aerator2.power_hp,
        "total_initial_cost": Math.ceil(data.farm.tod / aerator2.sotr) * aerator2.cost,
        "annual_energy_cost": 20000,
        "annual_maintenance_cost": Math.ceil(data.farm.tod / aerator2.sotr) * aerator2.maintenance,
        "annual_replacement_cost": (Math.ceil(data.farm.tod / aerator2.sotr) * aerator2.cost) / aerator2.durability,
        "total_annual_cost": 40000,
        "cost_percent_revenue": 8,
        "aerators_per_ha": Math.ceil(data.farm.tod / aerator2.sotr) / data.farm.farm_area_ha,
        "hp_per_ha": (Math.ceil(data.farm.tod / aerator2.sotr) * aerator2.power_hp) / data.farm.farm_area_ha,
